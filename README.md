...
SMILESClickChem is a cheminformatic, Python program for that crosses two parent ligands (SMILES string) to create a child compound. SMILESClickChem uses the crossover algorithm from the program AutoGrow4.
